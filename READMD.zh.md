...
| 2023年4月15日 | ChatGPT 等級的開源 RLHF                | Open Assistant 推出了一個模型，更重要的是，推出了一個通過 RLHF 進行對齊的數據集。在人類偏好方面，他們的模型接近 ChatGPT（

這些重要的事件標誌著開源語言模型的發展和進步。從最初的 LLaMA 啟動到多模態訓練和開源 RLHF 的實現，這些發展都為研究人員和開發人員帶來了巨大的機會。它們共同為建立強大、靈活和容易訪問的 AI 生態系統奠定了基礎。
 |
